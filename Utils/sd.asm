...
NONE:	LD	DE,FNF		;PREPARE MP/M ERROR MESSAGE
	...
	DEFB	'NO FILE$'
FNF:	DEFB	'File not found.$'
;
USRMSG:	DEFB	'Directory for user $'
USRMS2:	DEFB	':',13,10,'$'
;
...
TOTMS1:	DEFB	' : Total of $'
TOTMS2:	DEFB	'k in $'
TOTMS3:	DEFB	' files with $'
TOTMS4:	DEFB	'k space remaining.$'
;
FENCE:	
    IF	WIDE
	CALL	SPACE
...
;
	...
	RET	
;
EOSMSG:	DEFB	13,10,'(Strike any key to continue)$'
;
	IF	NOT WIDE
DRPRNT:	LD	A,(DRNAM)
	JP	TYPE
